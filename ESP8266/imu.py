...
def init_MPU(scl=5, sda=4):
    global i2c
    #instantiate the i2c interface on esp8266/32 (pins 5, 4 for esp8266 22,21 for wroom32 variants) 
    i2c = I2C(scl=machine.Pin(scl), sda=machine.Pin(sda), freq=400000)
