...
MM.Command.Value.execute = function() {
	...
	var newValue = prompt("指定项目值", oldValue);	
...
MM.Layout.Graph.Up = MM.Layout.Graph.create("top", "graph-top", "顶部");
MM.Layout.Graph.Left = MM.Layout.Graph.create("left", "graph-left", "左边");
MM.Layout.Graph.Right = MM.Layout.Graph.create("right", "graph-right", "右边");
...
MM.Layout.Tree.Left = MM.Layout.Tree.create("left", "tree-left", "左边");
MM.Layout.Tree.Right = MM.Layout.Tree.create("right", "tree-right", "右边");
...
MM.UI.Backend.show = function(mode) {
    ...
    this._go.innerHTML = (mode == "load" ? "加载" : "保存");
...
MM.UI.Backend.File.show = function(mode) {
	...
	this._go.innerHTML = (mode == "save" ? "保存" : "浏览");
}
